...
const updateSubmit = async () => {
  ...
  props.updateForm.put(route('clientes.update', {}), {
    onSuccess: () => {
      ...
      const index = props.dataRef.value.findIndex((item: any) => item.cli_id === props.updateForm.id);
      ...
      >
        <div class="grid gap-4 py-4">
          <div class="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="nombre" class="col-span-3" required v-model="updateForm.nombre" :disabled="updateForm.processing" />
          </div>
          <div class="grid grid-cols-4 items-center gap-4">
            <Label for="apellido" class="text-right">
              Apellido
            </Label>
            <Input id="apellido" class="col-span-3" required v-model="updateForm.apellido" :disabled="updateForm.processing" />
          </div>
          <div class="grid grid-cols-4 items-center gap-4">
            <Label for="email" class="text-right">
              Email
            </Label>
            <Input id="email" class="col-span-3" required v-model="updateForm.email" :disabled="updateForm.processing" />
          </div>
          <div class="grid grid-cols-4 items-center gap-4">
            <Label for="direccion" class="text-right">
              Dirección
            </Label>
            <Input id="direccion" class="col-span-3" required v-model="updateForm.direccion" :disabled="updateForm.processing" />
          </div>
        </div>
      </DialogItem>
